...
unsigned int nTargetSpacing = 1 * 30; // USACoin - 0.5 minute blocks
...
unsigned int nModifierInterval = 10 * 60; // USACoin - time to elapse before new modifier is computed
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "https://www.usatoday.com/story/tech/news/2017/07/04/how-iphone-changed-telecommunications-industry/103154146/";
        CTransaction txNew;
        txNew.nTime = 1499194312;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1499194312;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 5680554;
        ...
        assert(block.hashMerkleRoot == uint256("0x02b9326ecdf11ae436ffe470e419ff92711e570c42d2e1ee069cd8cb7665ee14"));
