...
private slots:
    ...
    void on_BuyUSACoin_clicked();
    void on_SellUSACoinBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputUSACoin_textChanged(const QString &arg1);
    ...
    QString BuyUSACoin(QString OrderType, double Quantity, double Rate);
    QString SellUSACoin(QString OrderType, double Quantity, double Rate);
