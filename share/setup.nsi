...
!define URL http://www.USACoin.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/USACoin.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\USACoin-qt.exe
...
OutFile USACoin-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/USACoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/USACoind.exe
    ...
    #Delete /REBOOTOK $INSTDIR\USACoin.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\USACoin-qt.exe
